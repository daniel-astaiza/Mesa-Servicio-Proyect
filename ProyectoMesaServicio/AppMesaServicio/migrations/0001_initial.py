...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='OficinaAmbinete',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Tipo', models.CharField(choices=[('administrativo', 'administrativo'), ('formacion', 'formacion')], db_comment='tipo de oficina', max_length=15)),
                ('Nombre', models.CharField(db_comment='nombre de oficina o del ambiente', max_length=40, unique=True)),
